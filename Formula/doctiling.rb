...
class Doctiling < Formula
  ...
  url "https://github.com/doctiling/releases/releases/download/v0.9.2/doctiling-standalone.tar.gz"
  sha256 "5c57e6dafcc828f574ac3d67346f80fac3d4accd25b4fbe2e9f797b693803cd6"
  version "0.9.2"
  license "UNLICENSED"
