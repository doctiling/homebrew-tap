...
class Doctiling < Formula
  ...
  url "https://github.com/doctiling/releases/releases/download/v0.7.8/doctiling-standalone.tar.gz"
  sha256 "12a4d5c7b3832dfe61581829dcbffc6949a1a6d2d800b6fbea15b51d71fe521a"
  version "0.7.8"
  license "UNLICENSED"
