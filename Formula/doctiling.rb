...
class Doctiling < Formula
  ...
  url "https://github.com/doctiling/releases/releases/download/v0.9.3/doctiling-standalone.tar.gz"
  sha256 "7f49eeb8b71d14701553124414afb3c2823bccdca9ba4141cd883ae63b2d39ef"
  version "0.9.3"
  license "UNLICENSED"
