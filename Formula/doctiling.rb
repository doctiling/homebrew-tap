...
class Doctiling < Formula
  ...
  url "https://github.com/doctiling/releases/releases/download/v0.9.1/doctiling-standalone.tar.gz"
  sha256 "692b449ad93c1e75130435ff0bf28c5537fcdf6ccef4986ca35d89ed10ef3325"
  version "0.9.1"
  license "UNLICENSED"
